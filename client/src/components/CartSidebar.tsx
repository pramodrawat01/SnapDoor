...
const CartSidebar = () => {
    ...
    // we have to charge deliveryFee as per distance also and the additional price added with order as well
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4 ">
            {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center ">
                    ...
                    <h3 className="text-lg font-medium mb-1">Your cart is empyt</h3>
        ...
        {/*** cart footer */}
        {
            items.length > 0 && (
                <div className=" p-5 border-t border-app-border space-y-3">
                    ...
                    <button className="w-full py-3 bg-app-orange text-white font-semibold rounded-xl
