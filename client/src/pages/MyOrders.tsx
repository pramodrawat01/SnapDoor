    ...
    <div className="min-h-screen bg-app-cream mb-20">
      ...
      {loading ? (
        ...
        <div className=" text-center py-16">
          ...
          <p className="tetx-sm text-app-text-light mb-4"> Start shopping to see your orders here</p>
          <Link to='/products'
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                ))}
                {
                  ...
                  sm:size-16 rounded-lg bg-app-cream flex-center text-xs font-semibold text-app-text-light">
              ...
              <div className="flex justify-between items-center pt-3 text-sm">
                <span className="flex justify-between items-center pt-3 text-sm">
