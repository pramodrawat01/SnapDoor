...
const Products = () => {
  ...
  const organic = searchParams.get("category") || ""
  ...
  return (
    <div className="min-hscreen bg-app-cream">
        ...
        <div className="flex gap-8 xl:gap-10">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
              <div className="bg-white rounded-2xl p-4 sticky top-24">
               ...
               maxPrice={maxPrice} updateFilter={updateFilter} clearFilter={clearFilters} hasFilters={hasFilters}/>
              </div>
          </aside>
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  <select value={sort} onChange={(e) => updateFilter("sort", e.target.value)}
                    className="appearance-none pl-3 pr-8 py-2 text-sm bbg-white rounded-xl border border-app-border focus:border-app-green outline-none couros-pointer"
                    >  
