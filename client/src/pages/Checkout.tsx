...
const Checkout = () => {
  ...
  const handlePlaceOrder = async () => {
    console.log("payment meothd", paymentMethod)
    setLoading(true)
    try {
      const orderData = {
  ...
  /// should it be useeffet or usstate ???
  useEffect(() => {
          ...
          <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span >{deliveryFee ===0 ? <span className="text-app-success">Free</span> : `${currency}${deliveryFee.toFixed(2)}`} {cartTotal.toFixed(2)}</span>
              </div>
