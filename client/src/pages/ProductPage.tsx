  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 ">
        ...
        {/** previus button */}
        <button className="mb-6 flex items-center gap-1.5 text-sm text-app-text-light hover:text-app-green transition-colors"
        onClick={()=> navigate(-1)}
        >
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative flex-center p-8 md:p-12 min-h-80 md:min-h-120">
              ...
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5 ">
                ...
                {
                  product.discount > 0 && (
                    <span className="px-1.5 py-1 text-sm font-semibold bg-app-orange text-white rounded-full">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              <span className="text-xs font-medium text-app-light-text tracking-wider mb-2 capitalize">
                {categoryLabel}
              </span>
              <h1 className="text-2xl md:text-3xl text-app-green mb-3">
                {product.name}
              </h1>
              ...
              {/** rating */}
              {
                product.rating > 0 && (
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <div className="flex items-center gap-0.5">
                      {
                        [1,2,3,4,5].map( (star) => (
                          <StarIcon key={star} className={ `w-4 h-4 
                            ${star <= Math.round(product.rating) ? "text-app-warning fill-app-warning" : "text-app-border"}`}/>
                        ))
                      }
                    </div>
                    ...
                    <span className="tedxt-sm text-app-text-light">
              ...
              <div className="mb-6">
                {product.stock > 0 ? (
                  ...
                  <span className="text-sm text-app-error font-medium">Our of stock</span>
                )}
              </div>
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                className="text-sm font-semibold text-app-orange hover:text-app-orange-dark flx items-center gap-1 transition-colors"
